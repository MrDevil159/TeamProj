...
<form class="wrapper" method="post" action="EditProfile">
  ...
  <div class="form-grp">
    ...
    <input type="text" name="name" value="<%= session.getAttribute("name") %>" placeholder="Enter Full name"/>
  </div>
  
  
  <div class="form-grp">
    <label>Email</label>
    <input type="text" name="email" value="<%= session.getAttribute("email") %>" placeholder="Enter Email"/>
  </div>
  
    <div class="form-grp">
    <label>Password</label>
    <input type="password" name="pwd" value="<%= session.getAttribute("pwd") %>" placeholder="Enter Password"/>
  </div>
  
  <div class="form-grp">
    <label>Phone</label>
    <input type="text" name="phone" value="<%= session.getAttribute("phone") %>" placeholder="Phone No."/>
  </div>
  ...
  <div class="form-grp">
    <label>Answer</label>
    <input type="text" name="ans" value="<%= session.getAttribute("ans") %>" placeholder="Answer"/>
  </div>
